...
//        add(scrollPane);
    ...
    private void initComponents() {
        ...
        btnKeranjang1.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Dress.jpg"))); // NOI18N
        gambar1.setMaximumSize(new java.awt.Dimension(178, 178));
        gambar1.setMinimumSize(new java.awt.Dimension(178, 178));
        gambar1.setPreferredSize(new java.awt.Dimension(178, 178));
        ...
        txtHarga1.setText(menu.getMenu().get("Dress").toString());
            ...
            .addGroup(menu1Layout.createSequentialGroup()
                ...
                .addGroup(menu1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, menu1Layout.createSequentialGroup()
                        .addComponent(tf1, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
        ...
        btnKeranjang2.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Blanket.jpg"))); // NOI18N
        gambar2.setMaximumSize(new java.awt.Dimension(178, 178));
        gambar2.setMinimumSize(new java.awt.Dimension(178, 178));
        ...
        txtHarga2.setText(menu.getMenu().get("Blanket").toString());
        ...
        btnKeranjang3.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Kebaya.jpg"))); // NOI18N
        ...
        txtHarga3.setText(menu.getMenu().get("Kebaya").toString());
        ...
        btnKeranjang4.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Outher.jpg"))); // NOI18N
        ...
        txtHarga4.setText(menu.getMenu().get("Outher").toString());
        ...
        btnKeranjang5.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Jacket.jpg"))); // NOI18N
        gambar5.setMaximumSize(new java.awt.Dimension(178, 178));
        gambar5.setMinimumSize(new java.awt.Dimension(178, 178));
        gambar5.setPreferredSize(new java.awt.Dimension(178, 178));
        ...
        txtHarga5.setText(menu.getMenu().get("Jacket").toString());
        ...
        btnKeranjang6.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gambar6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Jas.jpg"))); // NOI18N
        ...
        txtHarga6.setText(menu.getMenu().get("Jas").toString());
        ...
        btnKeranjang7.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Shoes.jpg"))); // NOI18N
        gambar7.setName(""); // NOI18N
        ...
        txtHarga7.setText(menu.getMenu().get("Shoes").toString());
        ...
        btnKeranjang8.setBackground(new java.awt.Color(0, 204, 204));
        ...
        gambar8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gambar8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Sweater.jpg"))); // NOI18N
        ...
        txtHarga8.setText(menu.getMenu().get("Sweater").toString());
        ...
        btnLihatKeranjang.setBackground(new java.awt.Color(0, 204, 204));
        ...
        txtMenu2.setText("Velvet Touch Launderette ");
    ...
    private void btnKeranjang1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang1ActionPerformed
        ...
        keranjang.tambahKeranjang("Dress", banyak1);
        banyak1 = 0;
        tf1.setText("0");
    ...
    private void btnKeranjang3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang3ActionPerformed
        ...
        keranjang.tambahKeranjang("Blanket", banyak3);
        banyak3 = 0;
        tf3.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang2ActionPerformed
        ...
        keranjang.tambahKeranjang("Kebaya", banyak2);
        banyak2 = 0;
        tf2.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang4ActionPerformed
        ...
        keranjang.tambahKeranjang("Outher", banyak4);
        banyak4 = 0;
        tf4.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang6ActionPerformed
        ...
        keranjang.tambahKeranjang("Jacket", banyak6);
        banyak6 = 0;
        tf6.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang5ActionPerformed
        ...
        keranjang.tambahKeranjang("Jas", banyak5);
        banyak5 = 0;
        tf5.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang7ActionPerformed
        ...
        keranjang.tambahKeranjang("Shoes", banyak7);
        banyak7 = 0;
        tf7.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private void btnKeranjang8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeranjang8ActionPerformed
        ...
        keranjang.tambahKeranjang("Sweater", banyak8);
        banyak8 = 0;
        tf8.setText("0");
        txtBanyakKeranjang.setText("Chart Amount : " + keranjang.jumlahKeranjang());
    ...
    private final javax.swing.JLabel logo = new javax.swing.JLabel();
